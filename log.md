...
| 2026-05-07 | INGEST | references/architecture-patterns-with-python.md | https://github.com/cosmicpython/book (CC-BY-ND) | claude-opus-4-7 | Architecture Patterns with Python (Percival & Gregory, O'Reilly 2020); reference summary with chapter-to-wiki map |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/overview.md | references/architecture-patterns-with-python.md | claude-opus-4-7 | Overview: layering philosophy, pattern catalog table, coupling interlude (Ch 3), project structure (App B) |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/domain-model.md | references/architecture-patterns-with-python.md Ch 1 | claude-opus-4-7 | Domain Model: entities, value objects, domain service, allocation domain example, test patterns |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/repository.md | references/architecture-patterns-with-python.md Ch 2 | claude-opus-4-7 | Repository Pattern (Tier 2 conceptual): classical ORM mapping, Protocol-based interface, fake repository |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/service-layer.md | references/architecture-patterns-with-python.md Ch 4 | claude-opus-4-7 | Service Layer: fetch-operate-commit, Flask as thin adapter, testing without HTTP |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/unit-of-work.md | references/architecture-patterns-with-python.md Ch 6 | claude-opus-4-7 | Unit of Work: context manager, FakeUoW, repository.seen, event collection |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/aggregates.md | references/architecture-patterns-with-python.md Ch 7 | claude-opus-4-7 | Aggregates: consistency boundary, optimistic concurrency via version_number, bounded context |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/domain-events-message-bus.md | references/architecture-patterns-with-python.md Ch 8–9 | claude-opus-4-7 | Domain Events + Message Bus: event dataclasses, in-process bus, bus as primary entrypoint, cascading dispatch |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/commands-vs-events.md | references/architecture-patterns-with-python.md Ch 10 | claude-opus-4-7 | Commands vs Events: routing rules, error propagation semantics, bus dispatch differences |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/event-driven-integration.md | references/architecture-patterns-with-python.md Ch 11 | claude-opus-4-7 | External events: Redis pub/sub, choreography vs orchestration, Distributed Ball of Mud, idempotency |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/cqrs.md | references/architecture-patterns-with-python.md Ch 12 | claude-opus-4-7 | CQRS: N+1 write-model read problem, raw-SQL read model, event-fed denormalized views |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/dependency-injection-bootstrap.md | references/architecture-patterns-with-python.md Ch 13 | claude-opus-4-7 | DI + Bootstrap: composition root, bootstrap.py, DI style comparison, MessageBus class |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/ports-and-adapters.md | references/architecture-patterns-with-python.md Preface + Ch 2,4 | claude-opus-4-7 | Ports and Adapters: hexagonal = onion = clean, inbound/outbound ports, functional core comparison |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/validation.md | references/architecture-patterns-with-python.md App E | claude-opus-4-7 | Validation placement: syntactic at edge, semantic in domain, pragmatic in service layer |
| 2026-05-07 | CREATE | wiki/tier2-core/architecture-patterns/legacy-migration.md | references/architecture-patterns-with-python.md Epilogue | claude-opus-4-7 | Legacy migration: Strangler Fig, architecture tax, incremental adoption, Django notes |
| 2026-05-07 | UPDATE | index.md | — | claude-opus-4-7 | Added Quick Reference rows, 13 Tier 2 catalog rows, source mapping; added/updated 25+ keyword index entries |
