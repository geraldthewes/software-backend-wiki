# XDG Base Directory Specification (Raw Reference)

> Source: https://specifications.freedesktop.org/basedir/latest/
> Version: 0.8 | Publication Date: 08 May 2021
> Authors: Waldo Bastian <bastian@kde.org>, Allison Karlitskaya <desrt@desrt.ca>, Lennart Poettering <lennart@poettering.net>, Johannes Löthberg <johannes@kyriasis.com>
> © Freedesktop.org
> Captured: 2026-07-09 (faithful markdown conversion of the HTML publication; read-only after ingest)
